  ...
  return (
    <div style={{ height: "100vh", width: "100%" }}>
      ...
      <button
        ...
        className="absolute   shadow-2xl transition-all duration-150 bottom-28 right-0 flex items-center justify-center  rounded-full bg-white p-1  cursor-pointer text-white   focus:ring-4 focus:bg-slate-100 font-medium text-sm   focus:outline-none "
      >
        <Image
          src={LocationImgUrl}
          style={{
