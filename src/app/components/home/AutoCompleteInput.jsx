      ...
      <>
        <div className="w-full relative bg-white  p-1 md:p-0 rounded-md">
          <input
            ...
            ref={inputRef}
            className="hidden md:block w-full rounded-md border-0 border-none py-2 px-4 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
            onKeyPress={(event) => {
              if (event.key === "Enter") {
                handleChackAvabilty();
              }
          ...
          <textarea
            ...
            placeholder={loading ? "please wait ...." : "Enter Your address"}
            ref={inputRef}
            className="md:hidden block w-full rounded-md border-0 py-2 px-4 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
            onKeyPress={(event) => {
              if (event.key === "Enter") {
                handleChackAvabilty();
              }
          ...
          <button
            ...
            className={`bg-primary border-none rounded-md ${styles.paragraph}  text-white px-4 py-2 hidden absolute md:flex top-0  md:bottom-[50%] right-0   h-full `}
          >
            Check availability
          </button>
