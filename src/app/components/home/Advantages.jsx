  ...
  return (
    <div className={`${styles.width} md:flex flex-wrap gap-5 pb-10 md:pb-20`}>
      {advantages.map((advantage) => (
        <div
          key={advantage.id}
          className="basis-[49%] mb-7 md:mb-5 cursor-pointer"
        >
          <Link href={advantage.link}>
            ...
            <p
              className={`pt-2 md:pt-1 pb-4 md:pb-5 text-[#4B5563] ${styles.paragraph}`}
            >
            ...
            >
              Learn More <BsArrowRightShort className="mt-1.5" />
            </p>
          </Link>
        </div>
      ))}
